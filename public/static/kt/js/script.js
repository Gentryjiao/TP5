...
// 			'<div class="col-md-1 col-sm-1 col-xs-1 car-goods-info">' +
// 			'<label><input type="checkbox" class="goods-list-item"/></label>' +
// 			'</div>' +
// 			'<div class="col-md-5 col-sm-5 col-xs-11 car-goods-info goods-image-column">' +
// 			'<img class="goods-image" src="' + item.imgUrl + '" style="width: 80px; height: 70px;" />' +
// 			'<span id="goods-info">' +
// 			item.goodsInfo +
// 			'</span>' +
// 			'</div>' +
// 			'<div class="col-md-1 col-sm-1 hidden-xs car-goods-info goods-price"><span>￥</span><span class="single-price">' + item.price + '</span></div>' +
// 			'<div class="col-md-1 col-sm-1 col-xs-2 car-goods-info goods-counts">' +
...
// 			'</div>' +
// 			'</div>' +
// 			'<div class="col-md-1 col-sm-1 col-xs-2 car-goods-info goods-money-count"><span class="single-name">￥</span><span class="single-total">' + item.singleGoodsMoney + '</span></div>' +
// 			'<div class="col-md-2 col-sm-2 car-goods-info goods-operate">' +
// 			'<button type="button" class="btn-delet btn-danger item-delete">删除</button>' +
// 			'</div>' +
// 			'</div>' +
// 			'</div>' +
// 			'</div>'
